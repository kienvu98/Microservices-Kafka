...
public class TwitterKafkaStatusListener extends StatusAdapter {
    ...
    public void onStatus(Status status) {
        LOG.info("Recevid status text {} seding to kafka topic {}", status.getText(), kafkaConfigData.getTopicName());
        // chuyển status thành Twitter avro model
        TwitterAvroModel twitterAvroModel = twitterStatusToAvroTransformer.getTwitterAvroModelFreomStatus(status);
